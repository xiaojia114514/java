  ...
  <el-card class="password-change-card">
    ...
    <el-form ref="passwordForm" :model="passwordForm" label-width="150px">
      <el-form-item
        ...
        :rules="[
          { required: true, message: $t(isTranslated ? 'order.messages.passwordRequired_en' : 'order.messages.passwordRequired_zh'), trigger: 'blur' }
        ]"
      >
        <el-input
          type="password"
      ...
      <el-form-item
        ...
        :rules="[
          { required: true, message: $t(isTranslated ? 'order.messages.newPasswordRequired_en' : 'order.messages.newPasswordRequired_zh'), trigger: 'blur' }
        ]"
      >
        <el-input
          type="password"
      ...
      <el-form-item
        ...
        :rules="[
          { required: true, message: $t(isTranslated ? 'order.messages.confirmPasswordRequired_en' : 'order.messages.confirmPasswordRequired_zh'), trigger: 'blur' }
        ]"
      >
        <el-input
          type="password"
